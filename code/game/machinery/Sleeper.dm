...
/obj/machinery/sleeper
	...
	var/list/possible_chems = list(
		...
		list(/datum/reagent/medicine/charcoal, /datum/reagent/medicine/mutadone, /datum/reagent/medicine/mannitol, /datum/reagent/medicine/salbutamol, /datum/reagent/medicine/pen_acid),

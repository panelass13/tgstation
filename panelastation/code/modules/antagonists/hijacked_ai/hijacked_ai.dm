...
/datum/antagonist/hijacked_ai/on_removal()
	if(owner.current && isAI(owner.current))
		...
		A.set_zeroth_law("")
		//A.verbs -= /mob/living/silicon/ai/proc/choose_modules //panela -- this was the original hippie code...
		//A.malf_picker.remove_malf_verbs(A) //p--but TG#49625 changed how this stuff works
		//qdel(A.malf_picker)
		A.remove_malf_abilities() //p--this should work however. but if it doesn't.. you know what to blame.

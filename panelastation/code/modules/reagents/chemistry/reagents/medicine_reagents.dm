...
/datum/reagent/medicine/salglu_solution
	...
	color = "#DCDCDC"
	metabolization_rate = 0.5 * REAGENTS_METABOLISM
	overdose_threshold = 0 // 60 -- 0 as hippie
...
/datum/reagent/medicine/mannitol/on_mob_life(mob/living/carbon/C)
	C.setOrganLoss(ORGAN_SLOT_BRAIN, -2*REM)
	..()
...
/datum/reagent/medicine/syndicate_nanites/on_mob_life(mob/living/carbon/M)
	...
	M.adjustToxLoss(-5*REM, 0)
	M.setOrganLoss(ORGAN_SLOT_BRAIN, -15*REM)
...
/datum/reagent/medicine/earthsblood/on_mob_life(mob/living/carbon/M)
	...
	M.adjustToxLoss(-3 * REM, 0)
	M.setOrganLoss(ORGAN_SLOT_BRAIN, 2*REM) //This does, after all, come from ambrosia, and the most powerful ambrosia in existence, at that!
...
/datum/reagent/medicine/haloperidol/on_mob_life(mob/living/carbon/M)
	...
	if (M.hallucination >= 5)
		M.hallucination -= 5
	if(prob(20))
		M.setOrganLoss(ORGAN_SLOT_BRAIN, 1*REM)
	M.adjustStaminaLoss(2.5*REM, 0)
	..()
	return TRUE
